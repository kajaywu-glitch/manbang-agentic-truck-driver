...
最后更新：2026-06-07 00:03 +08:00

本次更新：第四轮候选得到 148,027.03 净收入 / 7,185 罚分 / 17,278 Token，首次达到罚分目标，但净收入下降 6,269.49，且 Qwen 类别预算存在额度绕过、错误记账和日志格式缺陷，行为改动已回退。稳定基线继续保持 154,296.52 / 8,355 / 25,721。
